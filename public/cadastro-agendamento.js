...
// NOVA FUNÇÃO: Buscar percentual fixo do serviço
async function buscarPercentualComissao(id_servico) {
    try {
        ...
        return servico ? (servico.comissao_percentual || 50) : 50;
    } catch (error) {
...
// Função para confirmar o pagamento COM COMISSÃO FIXA
async function confirmarPagamento() {
    ...
    // BUSCAR PERCENTUAL FIXO DO SERVIÇO
